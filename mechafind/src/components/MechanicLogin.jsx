      ...
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: '3.5rem', fontWeight: '900', marginBottom: '20px', lineHeight: 1.1, color: '#fff' }}>
            Welcome back <br /><span style={{ color: '#fff' }}>Mechanic</span>
          </h1>
          <p style={{ fontSize: '1.2rem', color: 'rgba(255,255,255,0.8)', maxWidth: '400px' }}>
            Log in to your mechanic dashboard and manage your service requests.
          </p>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: '30px' }}>
            <h2 style={{ fontSize: '2rem', fontWeight: '800', margin: '0 0 10px', color: '#0f172a' }}>Mechanic Sign In</h2>
          ...
          <p style={{ textAlign: 'center', color: '#64748b', marginTop: '30px', fontSize: '14px' }}>
            Don't have an account? <Link to="/mechanic/register" style={{ color: '#0ea5e9', fontWeight: '700', textDecoration: 'none' }}>Create one</Link>
          </p>
